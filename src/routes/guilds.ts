                ...
                if (user.type === 'USER') {
                    if (req.body.name && req.body.name.length < 31) {
                        const guild = {
                            ...
                            public: false,
                            channels: [{ id: crypto.randomUUID(), name: 'general', topic: null, type: 'text', creation: Date.now(), roles: [{ id: '0', permissions: 456 }, { id: '1', permissions: 192 }], webhooks: [], messages: [], pins: [] }],
